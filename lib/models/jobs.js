...
job finished successfully..
    ...
    downloadTheArtifactsArchive(id, ref_name, params) { // eslint-disable-line camelcase
        return this.http.get(`/projects/${encodeURIComponent(id)}/jobs/artifacts/${encodeURIComponent(ref_name)}/download?job=name`, params); // eslint-disable-line quotes
    }
     ...
     * @param id {integer/string} - The ID or URL-encoded path of the project owned by the authenticated user
     * @param job_id {integer} - The unique job identifier
     * @param params {object}
