...
are paginated..
     ...
     * @param params.milestone {string} - The milestone title
     * @param params.scope {string} - Return issues for the given scope: created-by-me, assigned-to-me or all. Defaults to created-by-me (Introduced in GitLab 9.5)

     * @param params.author_id {integer} - Return issues created by the given user id. Combine with scope=all or scope=assigned-to-me. (Introduced in GitLab 9.5)

     * @param params.assignee_id {integer} - Return issues assigned to the given user id (Introduced in GitLab 9.5)

     * @param params.my_reaction_emoji {string} - Return issues reacted by the authenticated user by the given emoji (Introduced in GitLab 10.0)
...
use parameter scope=all..
     ...
     * @param params.milestone {string} - The milestone title
     * @param params.scope {string} - Return issues for the given scope: created-by-me, assigned-to-me or all (Introduced in GitLab 9.5)
     ...
     * @param params.created_after {datetime} - Return issues created after the given time (inclusive)
     * @param params.created_before {datetime} - Return issues created before the given time (inclusive)
     * @returns {*}
     */
     ...
     * @param params.milestone_id {integer} - The ID of a milestone to assign issue
     * @param params.labels {string} - Comma-separated label names for an issue
     * @param params.created_at {string} - Date time string, ISO 8601 formatted, e.g. 2016-03-11T03:45:40Z (requires admin or project owner rights)
     ...
     * @param params.weight {integer} - The weight of the issue in range 0 to 9
     * @returns {*}
     */
...
closed..
     ...
     * @param params.assignee_ids {Array[integer]} - The ID of the users to assign the issue to
     * @param params.milestone_id {integer} - The ID of a milestone to assign the issue to
     * @param params.labels {string} - Comma-separated label names for an issue
